...
if __name__ == '__main__':
    ...
    save_model_path = f'./experiments/models/{language}_seed{args.random_seed}_shorter{args.minimal_selection}_explosion{args.explosion_2nd}.p'
    save_loss_path = f'./experiments/loss/{language}_seed{args.random_seed}_shorter{args.minimal_selection}_explosion{args.explosion_2nd}.loss'
